...
if st.session_state.vectorstore is not None:
    ...
    if st.button("🤖 Get Career Coach Answer"):
        with st.spinner("Retrieving context and generating answer..."):
            answer, sources = run_career_coach(
                st.session_state.vectorstore, resume_text, jd_text, final_question
            )
    ...
    if st.button("Get Complete Career Report"):
        with st.spinner("Generating complete report..."):
            report, sources = generate_complete_report(
                st.session_state.vectorstore, resume_text, jd_text
            )
